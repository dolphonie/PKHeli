...
Current_Pwm_Limited_Remapped:	DS	1
Current_Pwm_Lim_Dith_Remapped: DS	1
...
ENDIF
	...
	; Pwm on cycle
	mov	A, Current_Pwm_Limited_Remapped ; Replace with remapped value -Patrick
...
t0_int_pwm_on_exit:
	...
	mov 	A, Current_Pwm_Limited_Remapped		; Load current pwm and replace with remapped value -Patrick
	cpl	A						; cpl is 255-x
IF MCU_48MHZ == 0
...
ELSE
	clr	C
	mov	A, Current_Pwm_Lim_Dith_Remapped ; Replace with remapped value -Patrick
	rlc	A
...
ENDIF
	...
	mov	A, Current_Pwm_Lim_Dith_Remapped		; Load current pwm and replace with remapped value -Patrick
	cpl	A						; Full pwm?
